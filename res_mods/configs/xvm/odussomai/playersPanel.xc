
{
  "def": {
    ...
    "hpBarBg": {
      ...
      "x": 106, "y": 6, "width": 72, "bindToIcon": true,
      "height": 14, "bgColor": "0x2e3436", "alpha": "{{alive?35|0}}"
    },
    "hpBar": {
      "enabled": false,
      "hotKeyCode": 56, "onHold": "true", "visibleOnHotKey": true,
      "x": 107, "y": 7, "bindToIcon": true,
      "width": "{{hp-ratio:70}}", "height": 12, "bgColor": "{{player?#FFDD33|{{c:system}}}}", "alpha": "{{alive?50|0}}"
    },
    "hp": {
      "enabled": false,
      "hotKeyCode": 56, "onHold": "true", "visibleOnHotKey": true,
      "x": 142, "width": 72, "y": 4, "bindToIcon": true, "alpha": "{{alive?100|0}}",
